...
//   // Get initial parameters from Physic class
//   const params = physics.getParams();
...
//     },
//     mode: currentMode // Add mode selector to GUI
//   };


 
//   gui.add(guiParams, 'mass', 50, 2000).onChange(value => {
//     const currentParams = physics.getParams();
//     physics.setParams({ ...currentParams, mass: value });
//   });

//   gui.add(guiParams, 'dragCon', 0.1, 1.0).onChange(value => {
//     const currentParams = physics.getParams();
//     physics.setParams({ ...currentParams, dragCon: value });
//   });

//   gui.add(guiParams, 'A', 0.5, 5.0).onChange(value => {
//     const currentParams = physics.getParams();
//     physics.setParams({ ...currentParams, A: value });
//   });

//   gui.add(guiParams, 'powerEngine', 50000, 100000).onChange(value => {
//     const currentParams = physics.getParams();
//     physics.setParams({ ...currentParams, powerEngine: value });
//   });

//   gui.add(guiParams, 'length', 1.0, 10.0).onChange(value => {
//     const currentParams = physics.getParams();
//     physics.setParams({ ...currentParams, length: value });
//   });
...
//   // const position = physics.jetski.position;
//   // if (Math.abs(position.x) > planeSize  || Math.abs(position.z) > planeSize ) {
//   //   //console.log('JetSki out of bounds. Reloading...');
